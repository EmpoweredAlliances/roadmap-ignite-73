...
const FooterSection = () => {
  return (
    <footer className="bg-primary px-5 py-10 text-center sm:px-8">
      ...
      <p className="mx-auto mt-3 max-w-[700px] font-body text-lg text-white whitespace-pre-line">
        We help leadership teams turn AI complexity into clear business priorities{"\n"}and build the internal capability to keep doing it.
      </p>
