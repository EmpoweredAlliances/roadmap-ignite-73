...
function isSafeCSSValue(value: string): boolean {
  const safePattern = /^(#[0-9a-fA-F]{3,8}|rgba?\([0-9,.\s%]+\)|hsla?\([0-9,.\s%/deg]+\)|var\(--[a-zA-Z0-9-]+\)|[a-z]{3,20})$/i;
  return safePattern.test(value.trim());
}

// Sanitize CSS identifier (keys used in custom property names)
